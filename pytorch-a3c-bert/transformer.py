...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, sources, source_mask):
        ...
        for encoder_layer in self.encoder_layers:
            sources = encoder_layer(sources, source_mask)
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None, layer_cache=None):
        ...
        batch_size,  d_model = key_projected.size()
        key_len = 1
        batch_size,  d_model = value_projected.size()
        value_len = 1
